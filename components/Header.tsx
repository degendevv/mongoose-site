...
const Header: React.FC = () => {
  return (
    <header>
      <nav className="flex flex-col lg:flex-row items-center flex-wrap p-6">
        <Link href="/" passHref>
          <a className="inline-flex items-center p-2 mr-4">
            <Image className="rounded-full" src="/logo.jpg" alt="Pepe Le Krabs" width={150} height={150} />
          </a>
        </Link>
        <h1 className="text-center flex-grow py-10 text-4xl font-bold">What could Mongoose do to Crypto Coin?</h1>
        <div className="text-center lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start flex flex-col lg:h-auto">
